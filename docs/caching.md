...
>
> Regenerate with: `./scripts/docs/generate.sh`. Support manifest schema: `9`;
...
|---|---|---|---|---|
| `aarch64-apple-darwin` | Advertised; local full-suite qualification required | — | Native artifact required | Active for structurally eligible `exact_rustc_result` units; exact compiler identity is part of every key |
