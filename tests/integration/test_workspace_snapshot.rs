...
#[test]
fn snapshot_adopts_a_lockfile_generated_by_its_initial_metadata_load() -> Result<()> {
...
#[test]
fn equivalent_checkout_roots_have_the_same_versioned_snapshot_id() -> Result<()> {
...
#[test]
fn snapshot_id_binds_lossless_rail_and_semantic_cargo_configuration() -> Result<()> {
...
#[test]
fn equivalent_git_checkouts_ignore_host_roots_and_git_object_ids() -> Result<()> {
