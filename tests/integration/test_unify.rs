...
#[test]
fn test_unify_doctor_reports_exact_resolution_domains_in_text_and_json() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_check_json_emits_versioned_feature_target_coverage_views() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_apply_restores_manifests_and_lockfile_when_a_late_output_fails() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_rejects_a_report_path_that_aliases_graph_state() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_resolution_based_merging_no_false_positives() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_syntactic_version_merging() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_major_version_conflict_warns_and_skips() {
    let result: Result<()> = (|| {
        let workspace = TestWorkspace::new()?;
...
#[test]
fn test_unify_inconsistent_default_features() {
    let result: Result<()> = (|| {
        let workspace = TestWorkspace::new()?;
...
#[test]
fn test_unify_dep_kinds_display() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_end_to_end_analyze_then_apply() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_exclude_config_and_flag() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_dev_dependencies() {
    let result: Result<()> = (|| {
        let workspace = TestWorkspace::new()?;
...
#[test]
fn test_unify_build_dependencies() {
    let result: Result<()> = (|| {
        let workspace = TestWorkspace::new()?;
...
#[test]
fn test_unify_existing_workspace_deps_update() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_existing_inherited_dependencies_are_not_noop_edits() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_package_inheritance_only_rewrites_captured_equivalent_fields() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_renamed_workspace_inheritance_keeps_exact_alias_authority() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_local_features_calculation() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_preserves_default_features_across_target_domains() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_target_specific_features_stay_local() {
    let result: Result<()> = (|| {
        let workspace = TestWorkspace::new()?;
...
#[test]
fn test_unify_workspace_member_version_deps_always_get_path() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_workspace_member_cohort_unifies_atomically() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_workspace_member_partial_exclude_applies_to_full_cohort() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_workspace_member_cohort_with_non_default_members_still_unifies() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_workspace_member_features_stay_local_not_hoisted() {
    let result: Result<()> = (|| {
...
"#,
        ...
        assert!(
            !workspace_toml.contains("core-member = { path = \"crates/core-member\", version = \"^0.1.0\", features")
                && !workspace_toml
                    .contains("core-member = { path = 'crates\\core-member', version = \"^0.1.0\", features"),
...
#[test]
fn test_unify_transitive_pinning() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_include_renamed_flag() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_include_renamed_merges_usage_count() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_renamed_dependencies_hard_blocker() {
    let result: Result<()> = (|| {
        let workspace = TestWorkspace::new()?;
...
"#,
        ...
        assert!(
            !crate_a_member.contains("serde = { workspace = true }")
                && !crate_a_member.contains("serde = {workspace=true}"),
...
#[test]
fn test_unify_include_forces_single_user_dep() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_exact_pin_handling_preserve() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_exact_pin_handling_skip() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_exact_pin_handling_warn() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_report_generation() {
    let result: Result<()> = (|| {
        let workspace = TestWorkspace::new()?;
...
#[test]
fn test_unify_apply_writes_mutation_receipts() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_apply_from_plan_file() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_check_json_runs_without_git_repository() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_dead_feature_pruning_preserves_published_api_flags() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_open_consumer_scope_preserves_dormant_private_features() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_graph_verification_uses_the_same_platform_filter_before_and_after() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_does_not_prune_cargo_synthetic_optional_features() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unify_feature_pruning_preserves_compiler_observed_optional_activation() {
    let result: Result<()> = (|| {
