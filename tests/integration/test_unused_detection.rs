...
#[test]
fn test_unused_detection_crate_name_normalization() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unused_detection_optional_dep_in_features_not_flagged() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unused_detection_multi_target_does_not_union_false_positive() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unused_detection_optional_dep_with_dep_syntax_not_flagged() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unused_detection_optional_dep_with_feature_syntax_not_flagged() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unused_detection_optional_deps_never_flagged() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unused_detection_target_specific_unconfigured_not_flagged() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unused_detection_truly_unused_dep_is_flagged() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unused_detection_workspace_member_not_flagged() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unused_detection_multi_target_union() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unused_detection_renamed_package_not_flagged() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unused_detection_keeps_duplicate_package_versions_and_aliases_distinct() {
    let result: Result<()> = (|| {
        let workspace = create_workspace_with_unused_detection()?;
        add_crate_with_manifest(
            &workspace,
...
#[test]
fn test_unused_detection_removes_unused_renamed_declaration_by_alias() {
    let result: Result<()> = (|| {
        let workspace = create_workspace_with_unused_detection()?;
...
#[test]
fn test_unused_detection_includes_workspace_inherited_declarations() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unused_detection_preserves_dependency_used_only_without_default_features() {
    let result: Result<()> = (|| {
        let workspace = create_workspace_with_unused_detection()?;
...
#[test]
fn test_unused_detection_plans_mutually_exclusive_feature_condition() {
    let result: Result<()> = (|| {
        let workspace = create_workspace_with_unused_detection()?;
...
#[test]
fn test_unused_detection_applies_independent_dev_build_and_optional_completeness() {
    let result: Result<()> = (|| {
        let workspace = create_workspace_with_unused_detection()?;
        add_crate_with_manifest(
            &workspace,
...
#[test]
fn test_unused_detection_checks_required_feature_cargo_target_configuration() {
    let result: Result<()> = (|| {
        let workspace = create_workspace_with_unused_detection()?;
        add_crate_with_manifest(
            &workspace,
...
#[test]
fn test_unused_detection_preserves_dependency_used_only_by_doctest() {
    let result: Result<()> = (|| {
        let workspace = create_workspace_with_unused_detection()?;
        add_crate_with_manifest(
            &workspace,
...
#[test]
fn test_unused_detection_preserves_dev_dependencies_used_by_examples_and_benchmarks() {
    let result: Result<()> = (|| {
        let workspace = create_workspace_with_unused_detection()?;
        add_crate_with_manifest(
            &workspace,
...
#[test]
fn test_unused_detection_preserves_dependency_used_only_by_proc_macro_expansion() {
    let result: Result<()> = (|| {
        let workspace = create_workspace_with_unused_detection()?;
        add_crate_with_manifest(
            &workspace,
...
log = "0.4"
# Deliberately unused so this fixture crosses the compiler-evidence cache boundary.
once_cell = "1"
"#,
        )?;
        fs::write(
...
#[test]
fn test_unused_detection_preserves_dependency_used_only_by_generated_source() {
    let result: Result<()> = (|| {
        let workspace = create_workspace_with_unused_detection()?;
        add_crate_with_manifest(
            &workspace,
...
#[test]
fn test_unused_detection_removes_unreachable_optional_only_from_private_package() {
    let result: Result<()> = (|| {
        let workspace = create_workspace_with_unused_detection()?;
        fs::write(
            workspace.path.join(".config/rail.toml"),
...
#[test]
fn test_unused_detection_separates_dev_and_build_compilation_domains() {
    let result: Result<()> = (|| {
        let workspace = create_workspace_with_unused_detection()?;
        fs::write(workspace.path.join(".config/rail.toml"), "")?;
        add_crate_with_manifest(
...
#[test]
fn test_unused_detection_preserves_build_dependency_with_native_links_contract() {
    let result: Result<()> = (|| {
        let workspace = create_workspace_with_unused_detection()?;
...
#[test]
fn test_unused_detection_common_patterns_no_false_positives() {
    let result: Result<()> = (|| {
...
#[test]
fn test_unused_detection_compiler_evidence_uses_shared_local_cas() {
    let result: Result<()> = (|| {
        let workspace = create_workspace_with_unused_detection()?;
