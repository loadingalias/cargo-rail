...
#[test]
fn test_hash_json_is_deterministic_for_same_inputs() {
    let result: Result<()> = (|| {
...
#[test]
fn test_plan_identity_is_portable_across_clone_paths() {
    let result: Result<()> = (|| {
...
#[test]
fn test_diff_hash_rejects_non_repository_relative_plan_paths() {
    let result: Result<()> = (|| {
...
#[test]
fn test_diff_hash_removes_external_checkout_paths_from_package_ids() {
    let result: Result<()> = (|| {
...
#[test]
fn test_diff_hash_reports_changes_between_plan_contracts() {
    let result: Result<()> = (|| {
