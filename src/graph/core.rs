...
impl WorkspaceGraph {
    ...
    pub fn transitive_dependent_pairs_of_set(
        &self,
...
mod tests {
    ...
    fn graph_preserves_same_name_packages_by_exact_package_id() {
        ...
        let ambiguous_graph = WorkspaceGraph::from_metadata(&metadata)
            .expect("synthetic duplicate-name workspace should remain representable");
