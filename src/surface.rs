...
impl SurfacePolicy {
  pub(crate) fn new(closed_world_packages: BTreeSet<CompilerFactPackage>, unnecessary_crate_visibility: bool) -> Self {
    Self {
...
mod tests {
  ...
  fn production_non_production_and_dead_public_classify_independently() {
    ...
    let test_object = object(
      ...
      vec![test_root.clone(), production, dead, non_production.clone()],
