...
mod tests {
    ...
    fn output_tree(bytes: &[u8], executable: bool) -> SourceTree {
        SourceTree::new(vec![
            ...
            SourceTreeEntry::symlink(Path::new("current.rs"), Path::new("generated.rs"))
                .expect("logical generated symlink"),
        ])
    ...
    fn result_digest_allows_internal_symlinks_but_rejects_escape() {
        ...
        safe.generated_outputs = Some(
            SourceTree::new(vec![
                SourceTreeEntry::symlink(Path::new("nested/link"), Path::new("../generated"))
