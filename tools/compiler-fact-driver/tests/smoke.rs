...
use fact_protocol::{
    ...
    CompilerFactRunAuthority, CompilerFactTargetKind, CompilerFactUnit, CompilerFactVisibility, CompilerItemFact,
};
...
fn assert_compiler_item_identities(fragment: &CompilerFactFragment) {
    ...
    assert_ne!(external_targets[0].0[0], external_targets[1].0[0]);
}
